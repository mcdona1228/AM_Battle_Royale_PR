...
public class GameUI : MonoBehaviour
{
    ...
    /*
    public string Feed(int enemyId)
    {
        string playerName = GameManager.instance.GetPlayer(curAttackerId).photonPlayer.NickName;
        string enemyName = GameManager.instance.GetPlayer(enemyId).photonPlayer.NickName;
        KillFeed.text =  playerName + " Killed " + enemyName + "\n";
        return null;
    }
    */
